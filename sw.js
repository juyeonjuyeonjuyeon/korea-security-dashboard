const CACHE = "security-board-v29";
const ASSETS = ["./", "./index.html", "./tech.html", "./scrap.html", "./reader.html", "./styles.css", "./reader.css", "./app.js", "./tech.js", "./bookmarks.js", "./scrap.js", "./reader.js", "./manifest.webmanifest", "./config/risk-weights.json", "./config/risk-model-history.json", "./config/sources.json", "./config/tech-sources.json", "./icon-32.png", "./icon-180.png", "./icon-192.png", "./icon-512.png", "./data/dashboard.json", "./data/tech.json", "./data/backtest.json", "./data/history/index.json"];
